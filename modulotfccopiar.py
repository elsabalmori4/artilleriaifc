...
def animar_trayectoria(v0, theta_, z0, ni):
	...
	# Crear la animación
	ani = FuncAnimation(fig, update, frames=range(1, len(x)), init_func=init, interval=20)
...
def angulo_disparo (objetivox):
	...
	if objetivox > alcancemaximo:
		...
		return 'ERROR: El alcance seleccionado debe ser mayor que cero'
	else:
